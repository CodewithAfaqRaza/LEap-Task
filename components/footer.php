<footer class="text-gray-400 border-t-[2px] border-[#c0ff00]  bg-gray-900 body-font">
        ...
        <div class="flex flex-wrap md:text-left text-center order-first">
            ...
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <div
                    ...
                    <button
                        class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded">Button</button>
                </div>
    ...
    <div class="bg-gray-800 border-t-[2px] border-b-[2px] border-[#c0ff00] bg-opacity-75">
